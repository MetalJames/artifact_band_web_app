...
export const bandInfo = {
    ...
    theBeginning: {
        ...
        captions: {
            ...
            breakLineText: "Artifact rehearsal room."
        }
    },
    ...
    livePerformancesAndRecognition: {
        ...
        images: {
            imageOne: {
                small: {
                    src: artifact_2007_live_small,
                    alt: "Artifact first Live event (small)",
                },
                full: {
    ...
    firstDemo : {
        ...
        images: {
            imageOne: {
                small: {
                    src: demo_cover_2010_small,
                    alt: "Artifact 2010 Demo Album (small)",
                },
                full: {
                    src: demo_cover_2010,
        ...
        captions: {
            demoCoverArt: "Demo Album - Official CD",
        },
    },
    ...
    artifactLineup2009_2010: {
        ...
        images: {
            imageOne: {
                small: {
                    src: artifact_2010_band_small,
                    alt: "Artifact 2009 Official Band Photo (small)",
                },
                full: {
            ...
            imageTwo: {
                small: {
                    src: demo_recording_2010_small,
                    alt: "Artifact 2010 Demo Recording (small)",
                },
                full: {
            ...
            imageThree: {
                small: {
                    src: artifact_2011_band_small,
                    alt: "Artifact 2010 Live Performance - Thrash Metal Festival (small)",
                },
                full: {
    ...
    deadSilenceAlbum: {
        ...
        images: {
            imageOne: {
                small: {
                    src: ds_album_small,
                    alt: "Artifact - Dead Silence CD (small)",
                },
                full: {
                    src: ds_album,
        ...
        captions: {
            officialCD: "Dead Silence - Official CD",
            coverArt: "Official Cover Art for Dead Silence Album"
        }
    },
