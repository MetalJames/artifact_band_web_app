...
export const ArtifactLineups = () => {
    return (
        <div className="mb-6">
            ...
            <p className="my-6">{bandInfo.artifactLineup2009_2010.description}</p>
            <div className="flex flex-col py-4 w-full border rounded-md bg-gray-600 bg-opacity-30 p-4">
                <div className="flex flex-col sm:flex-row justify-center items-center sm:gap-4 gap-2 w-full">
                    <img src={bandInfo.artifactLineup2009_2010.images.imageOne.small.src} alt={bandInfo.artifactLineup2009_2010.images.imageOne.small.alt} className="sm:w-1/4 w-full sm:h-48 h-auto object-cover rounded-lg shadow-md border"/>
                    <img src={bandInfo.artifactLineup2009_2010.images.imageTwo.small.src} alt={bandInfo.artifactLineup2009_2010.images.imageTwo.small.alt} className="sm:w-1/3 w-full sm:h-48 h-auto object-fit rounded-lg shadow-md border"/>
                    <img src={bandInfo.artifactLineup2009_2010.images.imageThree.small.src} alt={bandInfo.artifactLineup2009_2010.images.imageThree.small.alt} className="sm:w-1/4 w-full sm:h-48 h-auto object-cover rounded-lg shadow-md border"/>
                </div>
